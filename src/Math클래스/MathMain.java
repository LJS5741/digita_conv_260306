...
//        }
        ...
        while (true) {  // 중복이 몇 번 일어날 지 모르기 때문에 무한 반복문 처리
        ...
        int dif = Math.abs(minTemp) + Math.abs(maxTemp);
        System.out.println("최저기온 : " + minTemp);
        System.out.println("최고기온 : " + maxTemp);
        System.out.println("일교차 : " + dif);
    }
}
